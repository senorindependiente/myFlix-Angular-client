...
export class FetchApiDataService {
  ...
  // user get a single movie details
  ...
  // user get their profile information
  ...
  // user get their favorite movies
  ...
  // user can remove favorite movies from his list
